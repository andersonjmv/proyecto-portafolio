...
const colorName= {color: '#3b5998', padding: ' 0 1vh'};
const colorTwitter= {color:'#00acee', padding: '0 1vh' };
const colorLinkedin = {color: '#0e76a8', padding: '0 1vh'};
const colorGithub = {color: '#000', padding: '0 1vh'};
